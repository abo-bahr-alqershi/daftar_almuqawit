...
class PurchasesTutorialService {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // الوصف - مع تحكم ديناميكي بالارتفاع وتمييز الكلمات المهمة
              Flexible(
  ...
  static Widget _buildHighlightedDescription(String text) {
    ...
    final keywordStyles = <String, Color>{
      ...
      'فاتورة الشراء': AppColors.purchases,
      'إجمالي الفاتورة': AppColors.info,
      'سعر الشراء': AppColors.info,
      'الكمية': AppColors.primary,
      'طريقة الدفع': AppColors.warning,
      'محفظة المورد': AppColors.warning,
