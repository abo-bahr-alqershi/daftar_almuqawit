...
class _SalesScreenState extends State<SalesScreen>
  ...
  double _calculateTotalPaid(List<Sale> sales) =>
      sales.fold(0, (sum, sale) => sum + sale.paidAmount);

  double _calculateTotalRemaining(List<Sale> sales) =>
      sales.fold(0, (sum, sale) => sum + sale.remainingAmount);
  ...
  Widget _buildAnimatedBackground() => Container(
    ...
    child: CustomPaint(painter: _SalesBackgroundPainter()),
  );
  ...
  Widget _buildAdvancedSearchBar() => AnimatedContainer(
    duration: const Duration(milliseconds: 300),
  ...
  Widget _buildListHeader(int count) => Container(
  ...
  Widget _buildSalesList(List<Sale> sales) => ListView.builder(
    shrinkWrap: true,
          ...
          child: Opacity(
            ...
            child: Padding(
              ...
              child: SaleItemCard(
                ...
                onCancel: sale.status == 'نشط' ? () => _cancelSale(sale) : null,
              ),
            ),
          ),
        ),
  ...
  Widget _buildModernFAB() => Positioned(
    bottom: 20,
    left: 20,
  ...
  Widget _buildErrorState(SalesError state) => Container(
  ...
  Widget _buildNoResultsState() => Container(
    padding: const EdgeInsets.all(40),
    child: Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
...
class _SalesBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width * 0.8, size.height * 0.6), 120, paint);
  }
