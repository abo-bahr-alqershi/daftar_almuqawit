...
class _SaleDetailsScreenState extends State<SaleDetailsScreen>
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildAmountItem('المدفوع', widget.sale.paidAmount, AppColors.success),
              _buildAmountItem('المتبقي', widget.sale.remainingAmount, AppColors.warning),
  ...
  Widget _buildAmountItem(String label, double value, Color color) {
    return Column(
      children: [
        Container(
          width: 60,
