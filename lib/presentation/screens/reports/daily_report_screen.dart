...
class _DailyReportScreenState extends State<DailyReportScreen>
              ...
              child: BlocConsumer<ReportsBloc, ReportsState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is ReportsLoaded) {
                    ...
                    if (type != 'daily') return _buildLoadingState();
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'ليوم ${_displayFormat.format(_selectedDate)}',
                          style: TextStyle(
                            fontSize: 12,
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildStatCard(
                  'المشتريات',
                  (stats['totalPurchases'] as num?)?.toDouble() ?? 0.0,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow(
            'المصروفات',
            (stats['totalExpenses'] as num?)?.toDouble() ?? 0.0,
          ...
          _buildDetailRow(
            'الرصيد النقدي',
            (stats['cashBalance'] as num?)?.toDouble() ?? 0.0,
  ...
  Widget _buildChartSection(Map<String, dynamic> data) {
    ...
    final chartData = [
      ...
      ChartDataPoint(
        label: 'النقدي',
        value: (stats['cashSales'] as num?)?.toDouble() ?? 0.0,
        color: const Color(0xFF3B82F6),
      ),
      ChartDataPoint(
        label: 'الآجل',
        value: (stats['creditSales'] as num?)?.toDouble() ?? 0.0,
        color: const Color(0xFFF59E0B),
      ),
      ChartDataPoint(
        label: 'الربح',
        value: (stats['netProfit'] as num?)?.toDouble() ?? 0.0,
