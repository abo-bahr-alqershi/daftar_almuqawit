...
class InventoryTable {
  ...
  static const String cUnit = 'unit'; // ربطة، علاقية كيلو

  // الكميات
  static const String cCurrentQuantity = 'current_quantity'; // الكمية الحالية
  static const String cReservedQuantity =
      'reserved_quantity'; // الكمية المحجوزة
  static const String cAvailableQuantity =
      'available_quantity'; // الكمية المتاحة للبيع
  static const String cMinimumQuantity =
      'minimum_quantity'; // الحد الأدنى للتنبيه
