...
**دفتر المقاوت** هو تطبيق محاسبي شامل مصمم خصيصاً لإدارة أعمال بائعي القات. يوفر التطبيق حلولاً متكاملة لإدارة المبيعات، المشتريات، العملاء، الموردين، الديون، والتقارير المالية مع دعم كامل للعمل بدون اتصال بالإنترنت والمزامنة التلقائية.

## ✨ الميزات الرئيسية

### 💰 إدارة المبيعات
- **بيع سريع** مع واجهة سهلة الاستخدام
- تسجيل المبيعات بطرق دفع متعددة (نقدي، آجل، تحويل بنكي)
